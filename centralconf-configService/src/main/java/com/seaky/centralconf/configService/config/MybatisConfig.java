 ...
 */
@Configuration
@MapperScan("com.seaky.centralconf.configService.mapper")
public class MybatisConfig {
	...
	public SqlSessionFactoryBean sqlSessionFactoryBean() throws IOException {
		...
		Resource[] mapperResources = new PathMatchingResourcePatternResolver().getResources("classpath*:mybatis/mapper/*.xml");
