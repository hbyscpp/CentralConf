...
public class YtfmUserErrors {
	...
	public static final Errorcode ORGID_EMPTY = new Errorcode(Errorcode.BUSINESS_ERROR, 99, 10015, "未传入组织机构ID");
	public static final Errorcode ORG_MATCHING = new Errorcode(Errorcode.BUSINESS_ERROR, 99, 10016, "组织机构权限不匹配");
	...
	public static final Errorcode NO_CATALOG = new Errorcode(Errorcode.BUSINESS_ERROR, 99, 10020, "目录不存在");
	public static final Errorcode RES_REPEAT = new Errorcode(Errorcode.BUSINESS_ERROR, 99, 10021, "资源重复");
